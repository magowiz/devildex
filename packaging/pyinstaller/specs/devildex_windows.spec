...
a = Analysis(
    ...
    hiddenimports=['sqlalchemy', 'sqlalchemy.sql.default_comparator', 'sqlalchemy.dialects.sqlite', 'pkg_resources', 'devildex.database.db_manager', 'alembic.command', 'alembic.config', 'alembic.script'],
