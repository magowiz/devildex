...
def test_get_download_url_success(sample_version_details: dict):
...
def test_get_download_url_handles_protocol_relative_url(sample_version_details: dict):
...
def test_get_download_url_returns_none_for_missing_format(sample_version_details: dict):
...
def test_get_download_url_returns_none_for_missing_downloads_key():
...
def test_get_download_url_returns_none_for_empty_or_none_details():
...
def test_get_download_url_handles_non_standard_extension_url(caplog):
