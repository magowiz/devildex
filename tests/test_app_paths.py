...
# Import the constants from the module being tested
...
class TestAppPaths: # Changed from unittest.TestCase
    ...
    def test_init(self):
        ...
        app_paths_inner = AppPaths(app_name="TestApp", app_author="TestAuthor", version="1.0")
    ...
    def test_active_project_file(self):
        ...
        expected_path = self.tmp_path / "user_data" / ACTIVE_PROJECT_REGISTRY_SUBDIR / ACTIVE_PROJECT_REGISTRATION_FILENAME
        assert returned_path == expected_path
