...
class TestPackageSourceFetcherCoverage:
    ...
    def test_extract_zip_safely_unsafe_member_name(self):
        ...
        with patch('src.devildex.fetcher.PackageSourceFetcher._is_member_name_safe', return_value=False):
            assert not PackageSourceFetcher._extract_zip_safely(zip_path, self.BASE_SAVE_PATH / "extracted")
    ...
    def test_extract_tar_safely_unsafe_member_name(self, mock_tar_open):
        ...
        with patch('src.devildex.fetcher.PackageSourceFetcher._is_member_name_safe', return_value=False):
            ...
            assert not PackageSourceFetcher._extract_tar_safely(tar_path, self.BASE_SAVE_PATH / "extracted")
    ...
    def test_download_and_extract_archive_temp_base_dir_exists(self, mock_move, mock_ensure_target_dir, mock_cleanup_target_dir, mock_determine_content_source_dir, mock_extract_archive, mock_download_file):
        ...
        mock_determine_content_source_dir.return_value = self.BASE_SAVE_PATH / "content_source"
    ...
    def test_download_and_extract_archive_extract_fails(self, mock_extract_archive):
        fetcher = PackageSourceFetcher(self.BASE_SAVE_PATH, DUMMY_PACKAGE_INFO)
        assert not fetcher._download_and_extract_archive("http://example.com/archive.zip", self.BASE_SAVE_PATH / "temp_extract_fails")
    ...
    def test_download_and_extract_archive_determine_content_fails(self, mock_determine_content_source_dir, mock_extract_archive):
        fetcher = PackageSourceFetcher(self.BASE_SAVE_PATH, DUMMY_PACKAGE_INFO)
        assert not fetcher._download_and_extract_archive("http://example.com/archive.zip", self.BASE_SAVE_PATH / "temp_determine_fails")
    ...
    def test_download_and_extract_archive_ensure_target_fails(self, mock_ensure_target_dir, mock_determine_content_source_dir, mock_extract_archive):
        fetcher = PackageSourceFetcher(self.BASE_SAVE_PATH, DUMMY_PACKAGE_INFO)
        mock_determine_content_source_dir.return_value = self.BASE_SAVE_PATH / "content_source"
        assert not fetcher._download_and_extract_archive("http://example.com/archive.zip", self.BASE_SAVE_PATH / "temp_ensure_target_fails")
    ...
    def test_download_and_extract_archive_requests_exception(self, mock_requests_get):
        fetcher = PackageSourceFetcher(self.BASE_SAVE_PATH, DUMMY_PACKAGE_INFO)
        assert not fetcher._download_and_extract_archive("http://example.com/archive.zip", self.BASE_SAVE_PATH / "temp_requests_exception")
    ...
    @patch('src.devildex.fetcher.shutil.rmtree', side_effect=OSError("Permission denied"))
    ...
    @patch('src.devildex.fetcher.shutil.copy2', side_effect=OSError("Permission denied"))
